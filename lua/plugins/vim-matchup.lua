return { --https://github.com/andymass/vim-matchup
  ...
  event = 'BufEnter',
  enabled = false, -- I'm done, from time to time this plugins persistently slows something down. I'm pulling the plug 03-01-2025
  lazy = true,
  config = function()
    ...
    -- Lower the highlighting timeouts.
    -- Note that if highlighting takes longer than the timeout,
    -- highlighting will not be attempted again until the cursor moves.
    vim.g.matchup_matchparen_timeout = 10 -- Decrease timeout for matching
    --
    vim.g.matchup_matchparen_insert_timeout = 10
    --
    ...
    vim.g.matchup_delim_stopline = 55
    ...
    vim.g.matchup_matchparen_timeout = 300 --- adjust this
    vim.b.matchup_matchparen_timeout = 300 --- adjust this per buffer
    vim.b.matchup_matchparen_stopline = 400
  end,
}
